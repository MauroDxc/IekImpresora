...
namespace Impresora
{
    public partial class Ranurador : Form
    {
       RegistryKey rkApp = Registry.CurrentUser.OpenSubKey("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run", true);
        ...
        public Ranurador()
        {
            ...
            this.l25.TextChanged += new System.EventHandler(this.label25_TextChanged);
            this.l26.TextChanged += new System.EventHandler(this.label26_TextChanged);
            this.l27.TextChanged += new System.EventHandler(this.label27_TextChanged);
            this.l28.TextChanged += new System.EventHandler(this.label28_TextChanged);
            this.l29.TextChanged += new System.EventHandler(this.label29_TextChanged);
            this.l30.TextChanged += new System.EventHandler(this.label30_TextChanged);
            ...
            try
            {
                ...
                opcIdItems[1] = "LENZE.50MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[1] = 0;
                clientHandles[1] = 1;
                opcIdItems[2] = "LENZE.50MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[2] = 0;
                clientHandles[2] = 2;
                opcIdItems[3] = "LENZE.50MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[3] = 0;
                clientHandles[3] = 3;
                opcIdItems[4] = "LENZE.51MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[4] = 0;
                clientHandles[4] = 4;
                opcIdItems[5] = "LENZE.51MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[5] = 0;
                clientHandles[5] = 5;
                opcIdItems[6] = "LENZE.51MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[6] = 0;
                clientHandles[6] = 6;
                opcIdItems[7] = "LENZE.52MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[7] = 0;
                clientHandles[7] = 7;
                opcIdItems[8] = "LENZE.52MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[8] = 0;
                clientHandles[8] = 8;
                opcIdItems[9] = "LENZE.52MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[9] = 0;
                clientHandles[9] = 9;
                opcIdItems[10] = "LENZE.53MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[10] = 0;
                clientHandles[10] = 10;
                opcIdItems[11] = "LENZE.53MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[11] = 0;
                clientHandles[11] = 11;
                opcIdItems[12] = "LENZE.53MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[12] = 0;
                clientHandles[12] = 12;
                opcIdItems[13] = "LENZE.54MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[13] = 0;
                clientHandles[13] = 13;
                opcIdItems[14] = "LENZE.54MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[14] = 0;
                clientHandles[14] = 14;
                opcIdItems[15] = "LENZE.54MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[15] = 0;
                clientHandles[15] = 15;
                //opcIdItems[16] = "LENZE.25MS.APOS"; // De SW AUTO MAN
                //OPCItemIsArray[16] = 0;
                //clientHandles[16] = 16;
                //opcIdItems[17] = "LENZE.25MS.DESP"; // De SW AUTO MAN
                //OPCItemIsArray[17] = 0;
                //clientHandles[17] = 17;
                //opcIdItems[18] = "LENZE.25MS.EN_DESP"; // De SW AUTO MAN
                //OPCItemIsArray[18] = 0;
                //clientHandles[18] = 18;
                opcIdItems[19] = "LENZE.150MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[19] = 0;
                clientHandles[19] = 19;
                opcIdItems[20] = "LENZE.150MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[20] = 0;
                clientHandles[20] = 20;
                opcIdItems[21] = "LENZE.150MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[21] = 0;
                clientHandles[21] = 21;
                opcIdItems[22] = "LENZE.151MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[22] = 0;
                clientHandles[22] = 22;
                opcIdItems[23] = "LENZE.151MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[23] = 0;
                clientHandles[23] = 23;
                opcIdItems[24] = "LENZE.151MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[24] = 0;
                clientHandles[24] = 24;
                opcIdItems[25] = "LENZE.152MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[25] = 0;
                clientHandles[25] = 25;
                opcIdItems[26] = "LENZE.152MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[26] = 0;
                clientHandles[26] = 26;
                opcIdItems[27] = "LENZE.152MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[27] = 0;
                clientHandles[27] = 27;
                opcIdItems[28] = "LENZE.153MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[28] = 0;
                clientHandles[28] = 28;
                opcIdItems[29] = "LENZE.153MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[29] = 0;
                clientHandles[29] = 29;
                opcIdItems[30] = "LENZE.153MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[30] = 0;
                clientHandles[30] = 30;
        ...
        private void label1_TextChanged(Object sender, EventArgs e)
        {
            ...
            dat = Math.Round((dat + PR.getOffset("50")) / 1000, 3);
        ...
        private void label4_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("51")) / 1000, 3);
            numericUpDown6.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.Slotter);
        ...
        private void label5_TextChanged(Object sender, EventArgs e)
        {
            ...
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("51")) / 1000, 3);
            numericUpDown13.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.Slotter);
        ...
        private void label7_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("52")) / 1000, 3);
            numericUpDown5.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.Slotter);
        ...
        private void label8_TextChanged(Object sender, EventArgs e)
        {
            ...
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("52")) / 1000, 3);
            numericUpDown14.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.Slotter);
        ...
        private void label10_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("53")) / 1000, 3);
            numericUpDown4.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.Slotter53);
        ...
        private void label11_TextChanged(Object sender, EventArgs e)
        {
            ...
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("53")) / 1000, 3);
            numericUpDown15.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.Slotter53);
        ...
        private void label13_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("54")) / 1000, 3);
        ...
        private void label14_TextChanged(Object sender, EventArgs e)
        {
            ...
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("54")) / 1000, 3);
            numericUpDown10.Value = (Decimal)dat;
        ...
        private void label15_TextChanged(Object sender, EventArgs e)
        {
            ...
            {
                label20.ForeColor = Label.DefaultForeColor;
                numericUpDown10.BackColor = NumericUpDown.DefaultBackColor;
        ...
        private void label19_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("150")) / 1000, 3);
            numericUpDown25.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.SlotterCab); 
        }
        private void label20_TextChanged(Object sender, EventArgs e)
        {
            ...
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("150")) / 1000, 3);
            numericUpDown30.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.SlotterCab);
        }
        private void label21_TextChanged(Object sender, EventArgs e)
        {
            ...
            if (text.Text == "1")
            {
                ...
                numericUpDown30.BackColor = Color.Lime;
                label39.ForeColor = Color.Lime;
                numericUpDown25.BackColor = Color.Lime;
            ...
            {
                label47.ForeColor = Label.DefaultForeColor;
                numericUpDown30.BackColor = NumericUpDown.DefaultBackColor;
                label39.ForeColor = Label.DefaultForeColor;
                numericUpDown25.BackColor = NumericUpDown.DefaultBackColor;
                label34.ForeColor = Label.DefaultForeColor;
                numericUpDown17.BackColor = Color.White;
                label19.ForeColor = Label.DefaultForeColor;
                button13.BackColor = Button.DefaultBackColor;
                button25.BackColor = Button.DefaultBackColor;
        ...
        private void label22_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("151")) / 1000, 3);
            numericUpDown24.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.SlotterCab);
        }
        private void label23_TextChanged(Object sender, EventArgs e)
        {
            ...
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("151")) / 1000, 3);
            numericUpDown29.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.SlotterCab);
        }
        private void label24_TextChanged(Object sender, EventArgs e)
        {
            ...
            if (text.Text == "1")
            {
                ...
                numericUpDown29.BackColor = Color.Lime;
                label38.ForeColor = Color.Lime;
                numericUpDown24.BackColor = Color.Lime;
            ...
            {
                label46.ForeColor = Label.DefaultForeColor;
                numericUpDown29.BackColor = NumericUpDown.DefaultBackColor;
                label38.ForeColor = Label.DefaultForeColor;
                numericUpDown24.BackColor = NumericUpDown.DefaultBackColor;
                label28.ForeColor = Label.DefaultForeColor;
                numericUpDown9.BackColor = Color.White;
                label8.ForeColor = Label.DefaultForeColor;
                button12.BackColor = Button.DefaultBackColor;
                button24.BackColor = Button.DefaultBackColor;
        ...
        private void label25_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("152")) / 1000, 3);
            numericUpDown23.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.SlotterCab);
        }
        private void label26_TextChanged(Object sender, EventArgs e)
        {
            ...
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("152")) / 1000, 3);
            numericUpDown28.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.SlotterCab);
        }
        private void label27_TextChanged(Object sender, EventArgs e)
        {
            ...
            if (text.Text == "1")
            {
                ...
                numericUpDown28.BackColor = Color.Lime;
                label37.ForeColor = Color.Lime;
                numericUpDown23.BackColor = Color.Lime;
                label27.ForeColor = Color.Lime;
                numericUpDown8.BackColor = Color.Lime;
            ...
            {
                label45.ForeColor = Label.DefaultForeColor;
                numericUpDown28.BackColor = NumericUpDown.DefaultBackColor;
                label37.ForeColor = Label.DefaultForeColor;
                numericUpDown23.BackColor = NumericUpDown.DefaultBackColor;
                label27.ForeColor = Label.DefaultForeColor;
                numericUpDown8.BackColor = Color.White;
                label12.ForeColor = Label.DefaultForeColor;
                button11.BackColor = Button.DefaultBackColor;
                button23.BackColor = Button.DefaultBackColor;
        ...
        private void label28_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("153")) / 1000, 3);
        ...
        private void label29_TextChanged(Object sender, EventArgs e)
        {
            ...
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("153")) / 1000, 3);
            numericUpDown27.Value = (Decimal)dat;
        }
        private void label30_TextChanged(Object sender, EventArgs e)
        {
            ...
            if (text.Text == "1")
            {
                ...
                numericUpDown27.BackColor = Color.Lime;
                label36.ForeColor = Color.Lime;
                numericUpDown22.BackColor = Color.Lime;
            ...
            {
                label44.ForeColor = Label.DefaultForeColor;
                numericUpDown27.BackColor = NumericUpDown.DefaultBackColor;
                label36.ForeColor = Label.DefaultForeColor;
                numericUpDown22.BackColor = NumericUpDown.DefaultBackColor;
                label21.ForeColor = Label.DefaultForeColor;
                numericUpDown2.BackColor = Color.White;
                label10.ForeColor = Label.DefaultForeColor;
                button9.BackColor = Button.DefaultBackColor;
                button22.BackColor = Button.DefaultBackColor;
        ...
        {
            double pos = (double)numericUpDown7.Value - PR.getOffset("50") / 1000;
        ...
        {
            double pos = (double)numericUpDown6.Value - PR.getOffset("51") / 1000;
            double ajus = (double)numericUpDown20.Value;
            if (ajus != 0)
            {
                double x = (pos + ajus);
                double npos_conv = PR.ConvertTo(x, PR.FxTypes.Slotter);
        ...
        {
            double pos = (double)numericUpDown5.Value - PR.getOffset("52") / 1000;
        ...
        {
            double pos = (double)numericUpDown4.Value - PR.getOffset("53") / 1000;
            double ajus = (double)numericUpDown11.Value;
            if (ajus != 0)
            {
                double x = (pos + ajus);
                double npos_conv = PR.ConvertTo(x, PR.FxTypes.Slotter53);
                t11.Text = Math.Round(npos_conv * 1000).ToString();
                escribir(11);
                t12.Text = "1";
                escribir(12);
        ...
        {
            ////double pos = (double)numericUpDown3.Value;
        ...
        {
            double pos = (double)numericUpDown2.Value;
        ...
        {
            numericUpDown17.Value = numericUpDown17.Value * -1;
        }
        ...
        {
            double pos = (double)numericUpDown25.Value - PR.getOffset("150") / 1000;
            double ajus = (double)numericUpDown17.Value;
            if (ajus != 0)
            {
                double x = (pos + ajus);
                double npos_conv = PR.ConvertTo(x, PR.FxTypes.SlotterCab);
                t20.Text = Math.Round(npos_conv * 1000).ToString();
                escribir(20);
                t21.Text = "1";
                escribir(21);
        ...
        {
            double pos = (double)numericUpDown24.Value - PR.getOffset("151") / 1000;
            double ajus = (double)numericUpDown9.Value;
            if (ajus != 0)
            {
                double x = (pos + ajus);
                double npos_conv = PR.ConvertTo(x, PR.FxTypes.SlotterCab);
                t23.Text = Math.Round(npos_conv * 1000).ToString(); 
                escribir(23);
                t24.Text = "1";
                escribir(24);
                //numericUpDown9.Value = 0;
        ...
        {
            double pos = (double)numericUpDown23.Value - PR.getOffset("152") / 1000;
            double ajus = (double)numericUpDown8.Value;
            if (ajus != 0)
            {
                double x = (pos + ajus);
                double npos_conv = PR.ConvertTo(x, PR.FxTypes.SlotterCab);
                t26.Text = Math.Round(npos_conv * 1000).ToString(); 
                escribir(26);
                t27.Text = "1";
                escribir(27);
        ...
        {
            double pos = (double)numericUpDown22.Value - PR.getOffset("153") / 1000;
            double ajus = (double)numericUpDown2.Value;
            if (ajus != 0)
            {
                double x = (pos + ajus);
                double npos_conv = PR.ConvertTo(x, PR.FxTypes.SlotterCab);
                t29.Text = Math.Round(npos_conv * 1000).ToString(); 
                escribir(29);
                t30.Text = "1";
                escribir(30);
        ...
        private void numericUpDown9_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
        ...
        private void numericUpDown17_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (num.Value >= 0)
            {
                button13.Image = Impresora.Resources.Images.Add1;
            }
            else
            {
                button13.Image = Impresora.Resources.Images.Remove;
            }
        }
        ...
        private void numericUpDown9_ValueChanged_1(object sender, EventArgs e)
        {
            ...
            if (num.Value >= 0)
            {
                button12.Image = Impresora.Resources.Images.Add1;
            }
            else
            {
                button12.Image = Impresora.Resources.Images.Remove;
            }
        }
        ...
        private void numericUpDown8_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (num.Value >= 0)
            {
                button11.Image = Impresora.Resources.Images.Add1;
            }
            else
            {
                button11.Image = Impresora.Resources.Images.Remove;
            }
        }
        ...
        private void numericUpDown2_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (num.Value >= 0)
            {
                button9.Image = Impresora.Resources.Images.Add1;
            }
            else
            {
                button9.Image = Impresora.Resources.Images.Remove;
            }
        }
        ...
        private void Ranurador_Load(object sender, EventArgs e)
        {
        ...
        {
            double pos = (double)numericUpDown3.Value - PR.getOffset("54") / 1000;
            double ajus = (double)numericUpDown1.Value;
            if (ajus != 0)
            {
                double x = (pos + ajus);
                double npos_conv = x;
                t14.Text = Math.Round(npos_conv * 1000).ToString();
                escribir(14);
                t15.Text = "1";
                escribir(15);
                //numericUpDown11.Value = 0;
