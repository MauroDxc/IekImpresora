    ...
    public partial class SegundoColor : Form
    {
     RegistryKey rkApp = Registry.CurrentUser.OpenSubKey("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run", true);
        ...
        private void label1_TextChanged(Object sender, EventArgs e)
        {
            ...
            dat = Math.Round((dat + (bFS20 ? PR.getOffset("30") : 0)) / 1000, 3);
        ...
        private void label2_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS20e ? PR.getOffset("30") : 0)) / 1000, 3);
        ...
        private void label7_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS22 ? PR.getOffset("32") : 0)) / 1000, 3);
        ...
        private void label8_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS22e ? PR.getOffset("32") : 0)) / 1000, 3);
        ...
        private void label10_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS23 ? PR.getOffset("33") : 0)) / 1000, 3);
        ...
        private void label11_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS23e ? PR.getOffset("33") : 0)) / 1000, 3);
        ...
        private void label13_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS24 ? PR.getOffset("34") : 0)) / 1000, 3);
        ...
        private void label14_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS24e ? PR.getOffset("34") : 0)) / 1000, 3);
        ...
        private void label16_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS25 ? PR.getOffset("35") : 0)) / 1000, 3);
        ...
        private void label17_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS25e ? PR.getOffset("35") : 0)) / 1000, 3);
        ...
        {
            double pos = (double)numericUpDown6.Value - PR.getOffset("31") / 1000;
        ...
        {
            double pos = (double)numericUpDown5.Value - PR.getOffset("32") / 1000;
        ...
        {
            double pos = (double)numericUpDown4.Value - PR.getOffset("33") / 1000;
