...
namespace Impresora
{
    public partial class CuartoColor : Form
    {
        ...
        public CuartoColor()
        {
            ...
            try
            {
                ...
                opcIdItems[1] = "LENZE.130MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[1] = 0;
                clientHandles[1] = 1;
                opcIdItems[2] = "LENZE.130MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[2] = 0;
                clientHandles[2] = 2;
                opcIdItems[3] = "LENZE.130MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[3] = 0;
                clientHandles[3] = 3;
                opcIdItems[4] = "LENZE.131MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[4] = 0;
                clientHandles[4] = 4;
                opcIdItems[5] = "LENZE.131MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[5] = 0;
                clientHandles[5] = 5;
                opcIdItems[6] = "LENZE.131MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[6] = 0;
                clientHandles[6] = 6;
                opcIdItems[7] = "LENZE.132MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[7] = 0;
                clientHandles[7] = 7;
                opcIdItems[8] = "LENZE.132MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[8] = 0;
                clientHandles[8] = 8;
                opcIdItems[9] = "LENZE.132MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[9] = 0;
                clientHandles[9] = 9;
                opcIdItems[10] = "LENZE.133MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[10] = 0;
                clientHandles[10] = 10;
                opcIdItems[11] = "LENZE.133MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[11] = 0;
                clientHandles[11] = 11;
                opcIdItems[12] = "LENZE.133MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[12] = 0;
                clientHandles[12] = 12;
                opcIdItems[13] = "LENZE.134MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[13] = 0;
                clientHandles[13] = 13;
                opcIdItems[14] = "LENZE.134MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[14] = 0;
                clientHandles[14] = 14;
                opcIdItems[15] = "LENZE.134MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[15] = 0;
                clientHandles[15] = 15;
                opcIdItems[16] = "LENZE.135MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[16] = 0;
                clientHandles[16] = 16;
                opcIdItems[17] = "LENZE.135MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[17] = 0;
                clientHandles[17] = 17;
                opcIdItems[18] = "LENZE.135MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[18] = 0;
                clientHandles[18] = 18;
        ...
        private void label1_TextChanged(Object sender, EventArgs e)
        {
            ...
            dat = Math.Round((dat + PR.getOffset("130")) / 1000, 3);
        ...
        private void label4_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("131")) / 1000, 3);
        ...
        private void label7_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("132")) / 1000, 3);
        ...
        private void label10_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("133")) / 1000, 3);
        ...
        private void label13_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("134")) / 1000, 3);
        ...
        private void label16_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("135")) / 1000, 3);
        ...
        {
            double pos = (double)numericUpDown7.Value - PR.getOffset("130") / 1000; ;
        ...
        {
            double pos = (double)numericUpDown6.Value - PR.getOffset("131") / 1000; ;
        ...
        {
            double pos = (double)numericUpDown5.Value - PR.getOffset("132") / 1000;
        ...
        {
            double pos = (double)numericUpDown4.Value - PR.getOffset("133") / 1000;
        ...
        {
            double pos = (double)numericUpDown3.Value - PR.getOffset("134") / 1000;
        ...
        {
            double pos = (double)numericUpDown2.Value - PR.getOffset("135") / 1000;
