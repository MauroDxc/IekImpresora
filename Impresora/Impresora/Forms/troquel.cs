    ...
    public partial class troquel : Form
    {
        ...
        public troquel()
        {
            ...
            try
            {
                ...
                opcIdItems[1] = "LENZE.40MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[1] = 0;
                clientHandles[1] = 1;
                opcIdItems[2] = "LENZE.40MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[2] = 0;
                clientHandles[2] = 2;
                opcIdItems[3] = "LENZE.40MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[3] = 0;
                clientHandles[3] = 3;
                opcIdItems[4] = "LENZE.41MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[4] = 0;
                clientHandles[4] = 4;
                opcIdItems[5] = "LENZE.41MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[5] = 0;
                clientHandles[5] = 5;
                opcIdItems[6] = "LENZE.41MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[6] = 0;
                clientHandles[6] = 6;
                opcIdItems[7] = "LENZE.42MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[7] = 0;
                clientHandles[7] = 7;
                opcIdItems[8] = "LENZE.42MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[8] = 0;
                clientHandles[8] = 8;
                opcIdItems[9] = "LENZE.42MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[9] = 0;
                clientHandles[9] = 9;
                //opcIdItems[10] = "LENZE.43MS.APOS"; // De SW AUTO MAN
                //OPCItemIsArray[10] = 0;
                //clientHandles[10] = 10;
                //opcIdItems[11] = "LENZE.43MS.DESP"; // De SW AUTO MAN
                //OPCItemIsArray[11] = 0;
                //clientHandles[11] = 11;
                //opcIdItems[12] = "LENZE.43MS.EN_DESP"; // De SW AUTO MAN
                //OPCItemIsArray[12] = 0;
                //clientHandles[12] = 12;
                //opcIdItems[13] = "LENZE.44MS.APOS"; // De SW AUTO MAN
                //OPCItemIsArray[13] = 0;
                //clientHandles[13] = 13;
                //opcIdItems[14] = "LENZE.44MS.DESP"; // De SW AUTO MAN
                //OPCItemIsArray[14] = 0;
                //clientHandles[14] = 14;
                //opcIdItems[15] = "LENZE.44MS.EN_DESP"; // De SW AUTO MAN
                //OPCItemIsArray[15] = 0;
                //clientHandles[15] = 15;
        ...
        private void label1_TextChanged(Object sender, EventArgs e)
        {
            ...
            dat = Math.Round((dat + PR.getOffset("40")) / 1000, 3);
        ...
        private void label4_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("41")) / 1000, 3);
            numericUpDown6.Value = (Decimal)PR.ConvertFrom(dat,PR.FxTypes.UpperDiedCut);
        ...
        private void label5_TextChanged(Object sender, EventArgs e)
        {
            ...
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("41")) / 1000, 3);
            numericUpDown13.Value = (Decimal)PR.ConvertFrom(dat,PR.FxTypes.UpperDiedCut);
        ...
        private void label7_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("42")) / 1000, 3);
            numericUpDown5.Value = (Decimal)PR.ConvertFrom(dat,PR.FxTypes.LowerDiedCut);
        ...
        private void label8_TextChanged(Object sender, EventArgs e)
        {
            ...
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("42")) / 1000, 3);
            numericUpDown14.Value = (Decimal)PR.ConvertFrom(dat,PR.FxTypes.LowerDiedCut);
        ...
        {
            double pos = (double)numericUpDown7.Value - PR.getOffset("40") / 1000;
        ...
        {
            double pos = (double)numericUpDown6.Value - PR.getOffset("41") / 1000;
            double ajus = (double)numericUpDown20.Value;
            if (ajus != 0)
            {
                double x = (pos + ajus);
                double npos_conv = PR.ConvertTo(x, PR.FxTypes.UpperDiedCut);
        ...
        {
            double pos = (double)numericUpDown5.Value - PR.getOffset("42") / 1000;
            ...
            if (ajus != 0)
            {
                ...
                {
                    double x = (pos + ajus);
                    double npos_conv = PR.ConvertTo(x, PR.FxTypes.LowerDiedCut);
