...
namespace Impresora
{
    public partial class PrimerColor : Form
    {
        ...
        private bool bFS20 = true;
        private bool bFS20e = true;
        private bool bFS21 = true;
        private bool bFS21e = true;
        private bool bFS22 = true;
        private bool bFS22e = true;
        private bool bFS23 = true;
        private bool bFS23e = true;
        private bool bFS24 = true;
        private bool bFS24e = true;
        private bool bFS25 = true;
        private bool bFS25e = true;
        ...
        public PrimerColor()
        {
            ...
            try
            {
                ...
                opcIdItems[1] = "LENZE.20MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[1] = 0;
                clientHandles[1] = 1;
                opcIdItems[2] = "LENZE.20MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[2] = 0;
                clientHandles[2] = 2;
                opcIdItems[3] = "LENZE.20MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[3] = 0;
                clientHandles[3] = 3;
                opcIdItems[4] = "LENZE.21MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[4] = 0;
                clientHandles[4] = 4;
                opcIdItems[5] = "LENZE.21MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[5] = 0;
                clientHandles[5] = 5;
                opcIdItems[6] = "LENZE.21MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[6] = 0;
                clientHandles[6] = 6;
                opcIdItems[7] = "LENZE.22MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[7] = 0;
                clientHandles[7] = 7;
                opcIdItems[8] = "LENZE.22MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[8] = 0;
                clientHandles[8] = 8;
                opcIdItems[9] = "LENZE.22MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[9] = 0;
                clientHandles[9] = 9;
                opcIdItems[10] = "LENZE.23MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[10] = 0;
                clientHandles[10] = 10;
                opcIdItems[11] = "LENZE.23MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[11] = 0;
                clientHandles[11] = 11;
                opcIdItems[12] = "LENZE.23MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[12] = 0;
                clientHandles[12] = 12;
                opcIdItems[13] = "LENZE.24MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[13] = 0;
                clientHandles[13] = 13;
                opcIdItems[14] = "LENZE.24MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[14] = 0;
                clientHandles[14] = 14;
                opcIdItems[15] = "LENZE.24MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[15] = 0;
                clientHandles[15] = 15;
        ...
        private void label1_TextChanged(Object sender, EventArgs e)
        {
            ...
            dat = Math.Round((dat + (bFS20 ? PR.getOffset("20") : 0)) / 1000, 3);
            //bFS20 = bFS20 ? false : false;
        ...
        private void label2_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS20e ? PR.getOffset("20") : 0)) / 1000, 3);
            //bFS20e = bFS20e ? false : false;
        ...
        private void label4_TextChanged(Object sender, EventArgs e)
        {
                Label d = sender as Label;
                Double dat = Double.Parse(d.Text.ToString());
                dat = Math.Round((dat + PR.getOffset("21")) / 1000, 3);
                numericUpDown6.Value = (decimal)PR.ConvertFrom(dat, PR.FxTypes.UpperGap);
        }
        private void label5_TextChanged(Object sender, EventArgs e)
        {
                ...
                Double dat = Double.Parse(d.Text.ToString());
                dat = Math.Round((dat + PR.getOffset("21")) / 1000, 3);
                numericUpDown13.Value = (decimal)PR.ConvertFrom(dat, PR.FxTypes.UpperGap);
        }
        ...
        private void label7_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS22 ? PR.getOffset("22") : 0)) / 1000, 3);
            //bFS22 = bFS22 ? false : false;
            numericUpDown5.Value = (decimal)PR.ConvertFrom(dat, PR.FxTypes.UpperGap);
        }
        private void label8_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS22e ? PR.getOffset("22") : 0)) / 1000, 3);
            //bFS22e = bFS22e ? false : false;
            numericUpDown14.Value = (decimal)PR.ConvertFrom(dat, PR.FxTypes.UpperGap);
        }
        ...
        private void label10_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS23 ? PR.getOffset("23") : 0)) / 1000, 3);
            //bFS23 = bFS23 ? false : false;
        ...
        private void label11_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS23e ? PR.getOffset("23") : 0)) / 1000, 3);
            //bFS23e = bFS23e ? false : false;
        ...
        private void label13_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS24 ? PR.getOffset("24") : 0)) / 1000, 3);
            //bFS24 = bFS24 ? false : false;
        ...
        private void label14_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS24e ? PR.getOffset("24") : 0)) / 1000, 3);
            //bFS24e = bFS24e ? false : false;
        ...
        private void label16_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS25 ? PR.getOffset("25") : 0)) / 1000, 3);
            //bFS25 = bFS25 ? false : false;
        ...
        private void label17_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS25e ? PR.getOffset("25") : 0)) / 1000, 3);
            //bFS25e = bFS25e ? false : false;
        ...
        {
            double pos = (double)numericUpDown7.Value;// -PR.getOffset("20") / 1000;
        ...
        {
            double pos = (double)numericUpDown6.Value - PR.getOffset("21") / 1000; ;
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            if (ajus != 0)
            {
                try
                {
                    double npos = Math.Round((pos + ajus) * 1000);
        ...
        {
            double pos = (double)numericUpDown3.Value - PR.getOffset("24") / 1000;
        ...
        {
            double pos = (double)numericUpDown2.Value - PR.getOffset("25") / 1000;
        ...
        private void numericUpDown20_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
                button1_Click(button1, e);
        }

        private void numericUpDown12_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
                button4_Click(button4, e);
        }

        private void numericUpDown11_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
                button7_Click(button7, e);
        }

        private void numericUpDown10_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
        ...
        private void PrimerColor_Load(object sender, EventArgs e)
        {
        ...
        private void PrimerColor_KeyPress(object sender, KeyPressEventArgs e)
        {
