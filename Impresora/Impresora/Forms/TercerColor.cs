...
namespace Impresora
{
    public partial class TercerColor : Form
    {
       RegistryKey rkApp = Registry.CurrentUser.OpenSubKey("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run", true);
        ...
        public TercerColor()
        {
            ...
            try
            {
                ...
                opcIdItems[1] = "LENZE.120MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[1] = 0;
                clientHandles[1] = 1;
                opcIdItems[2] = "LENZE.120MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[2] = 0;
                clientHandles[2] = 2;
                opcIdItems[3] = "LENZE.120MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[3] = 0;
                clientHandles[3] = 3;
                opcIdItems[4] = "LENZE.121MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[4] = 0;
                clientHandles[4] = 4;
                opcIdItems[5] = "LENZE.121MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[5] = 0;
                clientHandles[5] = 5;
                opcIdItems[6] = "LENZE.121MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[6] = 0;
                clientHandles[6] = 6;
                opcIdItems[7] = "LENZE.122MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[7] = 0;
                clientHandles[7] = 7;
                opcIdItems[8] = "LENZE.122MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[8] = 0;
                clientHandles[8] = 8;
                opcIdItems[9] = "LENZE.122MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[9] = 0;
                clientHandles[9] = 9;
                opcIdItems[10] = "LENZE.123MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[10] = 0;
                clientHandles[10] = 10;
                opcIdItems[11] = "LENZE.123MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[11] = 0;
                clientHandles[11] = 11;
                opcIdItems[12] = "LENZE.123MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[12] = 0;
                clientHandles[12] = 12;
                opcIdItems[13] = "LENZE.124MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[13] = 0;
                clientHandles[13] = 13;
                opcIdItems[14] = "LENZE.124MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[14] = 0;
                clientHandles[14] = 14;
                opcIdItems[15] = "LENZE.124MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[15] = 0;
                clientHandles[15] = 15;
                opcIdItems[16] = "LENZE.125MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[16] = 0;
                clientHandles[16] = 16;
                opcIdItems[17] = "LENZE.125MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[17] = 0;
                clientHandles[17] = 17;
                opcIdItems[18] = "LENZE.125MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[18] = 0;
                clientHandles[18] = 18;
        ...
        private void label1_TextChanged(Object sender, EventArgs e)
        {
            ...
            dat = Math.Round((dat + (bFS20 ? PR.getOffset("120") : 0)) / 1000, 3);
        ...
        private void label2_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS20e ? PR.getOffset("120") : 0)) / 1000, 3);
        ...
        private void label4_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS21? PR.getOffset("121") : 0)) / 1000, 3);
            //bFS21 = bFS21 ? false : false;
        ...
        private void label5_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS21e? PR.getOffset("121") : 0)) / 1000, 3);
            //bFS21e = bFS21e ? false : false;
        ...
        private void label7_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS22 ? PR.getOffset("122") : 0)) / 1000, 3);
        ...
        private void label8_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS22e ? PR.getOffset("122") : 0)) / 1000, 3);
        ...
        private void label10_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS23 ? PR.getOffset("123") : 0)) / 1000, 3);
        ...
        private void label11_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS23e ? PR.getOffset("123") : 0)) / 1000, 3);
        ...
        private void label13_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS24 ? PR.getOffset("124") : 0)) / 1000, 3);
        ...
        private void label14_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS24e ? PR.getOffset("124") : 0)) / 1000, 3);
        ...
        private void label16_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS25 ? PR.getOffset("125") : 0)) / 1000, 3);
        ...
        private void label17_TextChanged(Object sender, EventArgs e)
        {
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + (bFS25e ? PR.getOffset("125") : 0)) / 1000, 3);
        ...
        {
            double pos = (double)numericUpDown7.Value - PR.getOffset("120") / 1000;
        ...
        {
            double pos = (double)numericUpDown6.Value - PR.getOffset("121") / 1000; ;
        ...
        {
            double pos = (double)numericUpDown5.Value - PR.getOffset("122") / 1000;
        ...
        {
            double pos = (double)numericUpDown4.Value - PR.getOffset("123") / 1000;
        ...
        {
            double pos = (double)numericUpDown3.Value - PR.getOffset("124") / 1000;
        ...
        {
            double pos = (double)numericUpDown2.Value - PR.getOffset("125") / 1000;
        ...
        private void TercerColor_Load(object sender, EventArgs e)
        {
