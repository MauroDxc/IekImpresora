    ...
    public partial class modulo1 : Form
    {
        ...
        public modulo1(string nombre)
        {
            ...
            try
            {
                ...
                grupoConectado = servidorOpc.OPCGroups.Add(grupo);
            ...
            try
            {
                ...
                opcIdItems[1] = "LENZE.10MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[1] = 0;
                clientHandles[1] = 1;
                opcIdItems[2] = "LENZE.10MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[2] = 0;
                clientHandles[2] = 2;
                opcIdItems[3] = "LENZE.10MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[3] = 0;
                clientHandles[3] = 3;
                opcIdItems[4] = "LENZE.11MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[4] = 0;
                clientHandles[4] = 4;
                opcIdItems[5] = "LENZE.11MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[5] = 0;
                clientHandles[5] = 5;
                opcIdItems[6] = "LENZE.11MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[6] = 0;
                clientHandles[6] = 6;
                opcIdItems[7] = "LENZE.12MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[7] = 0;
                clientHandles[7] = 7;
                opcIdItems[8] = "LENZE.12MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[8] = 0;
                clientHandles[8] = 8;
                opcIdItems[9] = "LENZE.12MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[9] = 0;
                clientHandles[9] = 9;
                opcIdItems[10] = "LENZE.13MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[10] = 0;
                clientHandles[10] = 10;
                opcIdItems[11] = "LENZE.13MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[11] = 0;
                clientHandles[11] = 11;
                opcIdItems[12] = "LENZE.13MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[12] = 0;
                clientHandles[12] = 12;
                opcIdItems[13] = "LENZE.14MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[13] = 0;
                clientHandles[13] = 13;
                opcIdItems[14] = "LENZE.14MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[14] = 0;
                clientHandles[14] = 14;
                opcIdItems[15] = "LENZE.14MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[15] = 0;
                clientHandles[15] = 15;
                opcIdItems[16] = "LENZE.15MS.APOS"; // De SW AUTO MAN
                OPCItemIsArray[16] = 0;
                clientHandles[16] = 16;
                opcIdItems[17] = "LENZE.15MS.DESP"; // De SW AUTO MAN
                OPCItemIsArray[17] = 0;
                clientHandles[17] = 17;
                opcIdItems[18] = "LENZE.15MS.EN_DESP"; // De SW AUTO MAN
                OPCItemIsArray[18] = 0;
                clientHandles[18] = 18;
        ...
        private void label1_TextChanged(Object sender, EventArgs e)
        {
            ...
            dat = Math.Round((dat + PR.getOffset("10"))/ 1000, 3);
        ...
        private void label4_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("11"))/ 1000, 3);
            numericUpDown6.Value = (Decimal)dat;
        ...
        private void label7_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("12"))/ 1000, 3);
            numericUpDown5.Value = (Decimal)dat;
        ...
        private void label10_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("13"))/ 1000, 3);
        ...
        private void label13_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("14"))/ 1000, 3);
            //numericUpDown3.Value = (Decimal)(-0.0000053639 * Math.Pow(dat, 3) + 0.0015 * Math.Pow(dat, 2) - 0.0140 * dat + 0.0538);
            numericUpDown3.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.Feeder);
        ...
        private void label14_TextChanged(Object sender, EventArgs e)
        {
            ...
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("14")) / 1000, 3);
            //numericUpDown16.Value = (Decimal)(-0.0000053639 * Math.Pow(dat, 3) + 0.0015 * Math.Pow(dat, 2) - 0.0140 * dat + 0.0538);
            numericUpDown16.Value = (Decimal)PR.ConvertFrom(dat, PR.FxTypes.Feeder);
        ...
        private void label16_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("15"))/ 1000, 3);
        ...
        private void label19_TextChanged(Object sender, EventArgs e)
        {
            ...
            Label d = sender as Label;
            Double dat = Double.Parse(d.Text.ToString());
            dat = Math.Round((dat + PR.getOffset("16"))/ 1000, 3);
            numericUpDown1.Value = (Decimal)dat;
        ...
        private void label21_TextChanged(Object sender, EventArgs e)
        {
            ...
            if (text.Text == "1")
            {
                ...
                numericUpDown19.BackColor = Color.Lime;
            ...
            else
            {
                ...
                numericUpDown19.BackColor = NumericUpDown.DefaultBackColor;
                label19.ForeColor = Label.DefaultForeColor;
                numericUpDown1.BackColor = NumericUpDown.DefaultBackColor;
        ...
        {
            double pos = (double)numericUpDown7.Value - PR.getOffset("10") / 1000; 
        ...
        {
            double pos = (double)numericUpDown6.Value - PR.getOffset("11") / 1000;
            double ajus = (double)numericUpDown20.Value;
            if (ajus != 0)
            {
                double npos = Math.Round((pos + ajus) * 1000);
                t05.Text = npos.ToString();
                escribir(5);
                t06.Text = "1";
                escribir(6);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            double pos = (double)numericUpDown5.Value - PR.getOffset("12") / 1000;
            double ajus = (double)numericUpDown12.Value;
            if (ajus != 0)
            {
                double npos = Math.Round((pos + ajus) * 1000);
                t08.Text = npos.ToString();
                escribir(8);
                t09.Text = "1";
                escribir(9);
        ...
        {
            double pos = (double)numericUpDown4.Value - PR.getOffset("13") / 1000;
        ...
        {
            double offset = PR.getOffset("14") / 1000;
            double pos = (double)numericUpDown3.Value - offset;
            double ajus = (double)numericUpDown10.Value;
            if (ajus != 0)
            {
                double x = (pos + ajus);
                double npos_conv = PR.ConvertTo(x, PR.FxTypes.Feeder);
        ...
        {
            double pos = (double)numericUpDown2.Value - PR.getOffset("15") / 1000;
        ...
        {
            double pos = (double)numericUpDown1.Value - PR.getOffset("16") / 1000;
            double ajus = (double)numericUpDown8.Value;
            if (ajus != 0)
            {
                double npos = Math.Round(pos + ajus) * 1000;
                t20.Text = npos.ToString();
                escribir(20);
                t21.Text = "1";
                escribir(21);
